...
export const metadata: Metadata = { title: "Editar — Equipo Directivo" };

const WRITE_ROLES = ["director", "utp", "superadmin"] as const;
const LIST_HREF = "/plataforma/equipo-institucional/directivo";

export default async function EditarDirectivoPage({ params }: { params: Promise<{ membershipId: string }> }) {
  ...
  if (!membership || membership.section !== "directivo") notFound();
    ...
    <div className="mx-auto max-w-2xl">
      <div className="flex items-center justify-between gap-3">
        ...
        <DeleteLinkButton
          ...
          confirmMessage={`¿Quitar a ${membership.staff_member.full_name} de Equipo Directivo? Su registro se mantiene si aparece en otra sección.`}
        />
      </div>
      <Card className="mt-6">
