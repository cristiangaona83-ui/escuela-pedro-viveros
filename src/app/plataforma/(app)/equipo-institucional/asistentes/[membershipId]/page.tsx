...
export const metadata: Metadata = { title: "Editar — Asistentes de la Educación" };

const WRITE_ROLES = ["director", "utp", "superadmin"] as const;
const LIST_HREF = "/plataforma/equipo-institucional/asistentes";

export default async function EditarAsistentePage({ params }: { params: Promise<{ membershipId: string }> }) {
  ...
  if (!membership || membership.section !== "asistente") notFound();
    ...
    <div className="mx-auto max-w-2xl">
      <div className="flex items-center justify-between gap-3">
        ...
        <DeleteLinkButton
          ...
          confirmMessage={`¿Quitar a ${membership.staff_member.full_name} de Asistentes de la Educación? Su registro se mantiene si aparece en otra sección.`}
        />
      </div>
      <Card className="mt-6">
