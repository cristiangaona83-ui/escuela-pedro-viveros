...
import { getGradingConfig, getCertificateSignature } from "@/services/school-config";
import { GradingScaleForm, SignatureForm } from "@/features/admin/ConfigForms";
import { SITE } from "@/config/site";

export const metadata: Metadata = { title: "Configuración institucional" };

export default async function ConfiguracionPage() {
  const [gradingConfig, signature] = await Promise.all([getGradingConfig(), getCertificateSignature()]);
