...
const SEGURO_ESCOLAR_ACCESS_ROLES = ["director", "superadmin", "inspectoria_general", "administrativo", "convivencia"] as const; // igual que el módulo Seguro Escolar (0046/0050)
