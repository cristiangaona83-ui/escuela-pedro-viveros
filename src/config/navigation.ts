...
export const PLATFORM_NAV: PlatformNavItem[] = [
  ...
  { label: "Estudiantes", href: "/plataforma/estudiantes", icon: "Users", roles: ["director", "utp", "administrativo", "docente", "pie", "convivencia", "superadmin"] },
  ...
  { label: "Asistencia", href: "/plataforma/asistencia", icon: "CalendarCheck", roles: ["director", "utp", "docente", "convivencia", "superadmin"] },
  ...
  { label: "PIE", href: "/plataforma/pie", icon: "HeartHandshake", roles: ["director", "utp", "pie", "superadmin"] },
