...
/** Filtro de año académico (y período, para el Informe Semestral) controlado por la URL -- mismo criterio que el resto de la plataforma (ej. PeriodFilterBar de Reportes de Asistencia): la página server component recalcula todo al navegar. */
export function InformesFilterBar({
  academicYears,
  periods,
  year,
  period,
  ...
  return (
    <div className="flex flex-wrap items-end gap-3">
      ...
      <div className="w-56">
        <label className="mb-1 block text-xs font-medium text-slate-500">Período (Informe Semestral)</label>
